...
public class EMBJavaSupport {
	...
	public static native int FPDFReflowAllocPage();
	public static native int FPDFReflowStartParse(int reflowPage,int page,int width,int fitPageHight,int pauseHandler,int nFlag);
	public static native int FPDFReflowGetPageHight(int reflowPage);
	public static native int FPDFReflowGetPageWidth(int reflowPage);
	public static native int FPDFReflowStartRender(int dib, int reflowPage, int start_x, int start_y, 
			int size_x, int size_y, int rotate, int pauseHandler);
	public static native int FPDFReflowSetDitherBits(int reflowPage,int DitherBits);
}