...
public class EMBJavaSupport {
	...
	public static native int FPDFTextLoadPage(int page) throws invalidLicenseException, parameterException;
	public static native void FPDFTextCloseTextPage(int textpagehandle);
	public static native int FPDFTextCountChars(int textpage) throws invalidLicenseException, parameterException, memoryException;
	public static native int FPDFTextCountRects(int textpage, int start, int count) throws invalidLicenseException, parameterException, memoryException;
	public static native RectangleF FPDFTextGetRect(int textpage, int index) throws invalidLicenseException, parameterException, memoryException;
	public static native String FPDFTextGetText(int textpage, int start, int count) throws invalidLicenseException, parameterException, memoryException;
	public static native void FPDFPagePageToDeviceRectF(int page, int start_x, int start_y, 
			int size_x, int size_y, int rotate, RectangleF rect) throws parameterException;
