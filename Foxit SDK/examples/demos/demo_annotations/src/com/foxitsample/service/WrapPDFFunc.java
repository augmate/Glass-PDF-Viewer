...
public class WrapPDFFunc
{
	...
	public int addAnnot(int nAnnotType) throws memoryException{
		...
		switch(nAnnotType){
			...
			case EMBJavaSupport.EMBJavaSupport_ANNOTTYPE_NOTE:{
				...
				int nNoteInfoItem = EMBJavaSupport.FPDFNoteInfoAlloc("James", 0x0000ff, 80, pdfRect, "I like note",nPDFCurPageHandler);
				nCount = EMBJavaSupport.FPDFAnnotGetCount(nPDFCurPageHandler);
				int nIndex = EMBJavaSupport.FPDFAnnotAdd(nPDFCurPageHandler, EMBJavaSupport.EMBJavaSupport_ANNOTTYPE_NOTE, nNoteInfoItem);
				...
				int nRet = EMBJavaSupport.FPDFPageDeviceToPageRectF(nPDFCurPageHandler, 0, 0, nDisplayX, nDisplayY, 0, deviceRect);
				deviceRect.right = deviceRect.left + 20;
				deviceRect.bottom = deviceRect.top - 20;
				nNoteInfoItem = EMBJavaSupport.FPDFNoteInfoAlloc("James", 0xff00ff, 80, deviceRect, "I like note too",nPDFCurPageHandler);
				nIndex = EMBJavaSupport.FPDFAnnotAdd(nPDFCurPageHandler, EMBJavaSupport.EMBJavaSupport_ANNOTTYPE_NOTE, nNoteInfoItem);
				arrIndexList.add(nIndex);
				EMBJavaSupport.FPDFNoteInfoRelease(nNoteInfoItem);
			...
			case EMBJavaSupport.EMBJavaSupport_ANNOTTYPE_HIGHLIGHT:{
				...
				int nQuadsCount = 1;
				int nHighlightInfo = EMBJavaSupport.FPDFHighlightInfoAlloc("James", 0x00ff00, 80, nQuadsCount);
				float[] quads = {rect.left,rect.top,rect.right,rect.top,rect.left,rect.bottom,rect.right,rect.bottom};
				int nQuadsInfo = EMBJavaSupport.FPDFQuadsInfoAlloc(nQuadsCount, quads);
				EMBJavaSupport.FPDFHighlightSetQuads(nHighlightInfo, nQuadsInfo);
				
				int nIndex = EMBJavaSupport.FPDFAnnotAdd(nPDFCurPageHandler, EMBJavaSupport.EMBJavaSupport_ANNOTTYPE_HIGHLIGHT, nHighlightInfo);
				arrIndexList.add(nIndex);
			...
			case EMBJavaSupport.EMBJavaSupport_ANNOTTYPE_PENCIL:{
				...
				int nIndex = EMBJavaSupport.FPDFAnnotAdd(nPDFCurPageHandler, EMBJavaSupport.EMBJavaSupport_ANNOTTYPE_PENCIL, nPencilInfoItem);
				arrIndexList.add(nIndex);
			...
			case EMBJavaSupport.EMBJavaSupport_ANNOTTYPE_STAMP:{
				...
				int nIndex = EMBJavaSupport.FPDFAnnotAdd(nPDFCurPageHandler, EMBJavaSupport.EMBJavaSupport_ANNOTTYPE_STAMP, nStampInfo);
				arrIndexList.add(nIndex);
			...
			case EMBJavaSupport.EMBJavaSupport_ANNOTTYPE_FILEATTACHMENT:{
				...
				int nFileAttachmentInfo = EMBJavaSupport.FPDFFileAttachmentInfoAlloc("James", 0x0000ff, 80, rect, filepath);
				int nIndex = EMBJavaSupport.FPDFAnnotAdd(nPDFCurPageHandler, EMBJavaSupport.EMBJavaSupport_ANNOTTYPE_FILEATTACHMENT, nFileAttachmentInfo);
				arrIndexList.add(nIndex);
	...
	public int deleteFileAttachment(int x, int y){
		int annot_index = EMBJavaSupport.FPDFAnnotGetIndexAtPos(nPDFCurPageHandler, x, y);
		int nRet = EMBJavaSupport.FPDFAnnotDelete(nPDFCurPageHandler, annot_index);
