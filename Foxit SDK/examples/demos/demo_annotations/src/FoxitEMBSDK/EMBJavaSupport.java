...
public class EMBJavaSupport {
	...
	public static native int FPDFDocSaveAs(int document, int flag, int pause,int filewrite);
	...
	public static native int FPDFPageDeviceToPageRectF(int page, int start_x, int start_y, 
	...
	////////////Annotation
	public static native int FPDFNoteInfoAlloc(String author, long color, int opacity, RectangleF rect, String content,int page);
	public static native void FPDFNoteInfoRelease(int nNoteInfoHandler);
	
	public static native int FPDFPencilInfoAlloc(String author, long color, int opacity, boolean busebezier,
											boolean boptimize, int line_width, int line_count);
	public static native void FPDFPencilInfoSetLineInfo(int nPencilInfo, int nLineInfo);
	...
	public static native void FPDFLineInfoSetPointInfo(int nLineInfo, int line_index, int nPointCounts, float[] points);
	public static native void FPDFLineInfoRelease(int nLineInfo);	
	
	public static native int FPDFHighlightInfoAlloc(String author, long color, int opacity, int quad_count);
	public static native void FPDFHighlightSetQuads(int nHighlightInfo, int nQuads);
	...
	public static native int FPDFStampInfoAlloc(String author, long color, int opacity, RectangleF pdfRect, 
											String subject, String image_path);
	public static native void FPDFStampInfoRelease(int nStampInfo);
	
	public static native int FPDFFileAttachmentInfoAlloc(String author, long color, int opacity,
											RectangleF pdfRect, String filepath);
	public static native void FPDFFileAttachmentInfoRelease(int nFileAttachmentInfo);	
	...
	public static native int FSFileWriteAlloc(String filePath) throws memoryException;
